#+TITLE: Split Tunneling for Wireguard on Linux

If you're under a VPN with WireGuard on Linux, as of writing this, there seems to be a surprising lack of documentation for selectively split tunneling certain applications. Fortunately, with Linux [[https://https://en.wikipedia.org/wiki/Cgroup][network namespaces]] , we are able to do just that.

* TL;DR
[[https://github.com/yanghuauxan/stun][Use my script :)]]
